...
<div class="container-fluid">
    ...
    <!-- Navigasi -->
    <?php if ($hal_aktif > 1) : ?>
        <a href="?page=tabel&hal=<?php echo $hal_aktif - 1 ?>" class=" btn btn-sm btn-primary">Previous</a>
    <?php endif; ?>
    <?php for ($i = 1; $i <= $hal; $i++) : ?>
        <?php if ($i == $hal_aktif) : ?>
            <a style="font-weight: bold; color:#913f9e" href="?page=tabel&hal=<?php echo $i ?>"><?php echo $i ?></a>
        <?php else : ?>
            <a href="?page=tabel&hal=<?php echo $i ?>"><?php echo $i ?></a>
        <?php endif; ?>
    <?php endfor ?>
    <?php if ($hal_aktif < $hal) : ?>
        <a href="?page=tabel&hal=<?php echo $hal_aktif + 1 ?>" class=" btn btn-sm btn-primary">Next</a>
    <?php endif; ?>
